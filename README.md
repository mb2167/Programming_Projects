...
**Current Progress:**  
- Basic gravitational orbit simulation implemented.  
- Fragmentation scoring designed for future collision modelling.

**Goals:**  
- Add collision and merging logic.  
...
**Features:**  
- Scrapes one or more users’ Letterboxd watchlists  
...
**Configuration:**  
A configurable `config.json` file allows:  
- Adding user groups  
- API key entry  
